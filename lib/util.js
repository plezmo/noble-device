...
if('win32' == os.platform()) {
  var rel = os.release();
  var partsOfRel = rel.split(".");
  var majorVersion = parseInt(partsOfRel[0]);
  // var minorVersion = parseInt(partsOfRel[1]);
  // var buildVersion = parseInt(partsOfRel[2]);
  // if((10 === majorVersion) && (0 === minorVersion) && (buildVersion >= 15063)) {
  if(10 == majorVersion) {
